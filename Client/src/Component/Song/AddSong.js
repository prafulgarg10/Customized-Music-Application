...
function AddSong() {
  ...
  function clickHandler(event) {
    ...
    Axios.post("http://localhost:3001/add", addData).then(
      (res) => {
        if (res.status === 200) {
          document.getElementById("feed_s").style.color = "green";
          document.getElementById("feed_s").innerHTML =
      ...
      <Container className="mt-3">
        ...
        >
          <div className="mb-3 row">
            <label for="song" className="col-sm-2 col-form-label">
              Song Name
            </label>
          ...
          <div className="mb-3 row">
            <label for="artwork" className="col-sm-2 col-form-label">
              Artwork
            </label>
            <div className="col-sm-10">
              <input
          ...
          <div className="mb-3 row">
            <label for="artist" className="col-sm-2 col-form-label">
              Artist
            </label>
            <div className="col-sm-8">
              <select class="form-select" id="artist" required ref={artistRef}>
                ...
                {artist.map((artists) => {
                  return <option value={artists.Id}>{artists.Name}</option>;
                })}
              </select>
            </div>
            <div
            ...
            >
              ...
              <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                  <AddArtist artistInserted={setArtistAdded} />
                </Modal.Body>
                <Modal.Footer>
